...
if not os.path.exists("../models/prerun/sensitivity_00.nc"):
    idata_bf_00.to_netcdf("../models/prerun/sensitivity_00.nc")
idata_bf_00 = azp.convert_to_datatree("../models/prerun/sensitivity_00.nc")
```
...
```{python}
azp.psense_summary(idata_bf_00, var_names=["~μ"], round_to=2)
```
...
if not os.path.exists("../models/prerun/sensitivity_01.nc"):
    idata_bf_01.to_netcdf("../models/prerun/sensitivity_01.nc")
idata_bf_01 = azp.convert_to_datatree("../models/prerun/sensitivity_01.nc")
```
...
```{python}
azp.psense_summary(idata_bf_01, var_names=["~μ"])
```
...
if not os.path.exists("../models/prerun/sensitivity_02.nc"):
    idata_bt.to_netcdf("../models/prerun/sensitivity_02.nc")
idata_bt = azp.convert_to_datatree("../models/prerun/sensitivity_02.nc")
```
...
```{python}
azp.psense_summary(idata_bt, var_names=["~b_Intercept"])
```
